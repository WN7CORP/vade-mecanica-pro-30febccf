...
const StudyMode = () => {
  ...
  const handleRate = (correct: boolean) => {
    ...
    if (userId && lawName) {
      logUserActivity(correct ? 'flashcard_correct' : 'flashcard_incorrect', lawName, flashcards[currentIndex]?.id.toString() || '');
    }
  };
        ...
        <Tabs defaultValue="flashcards" className="w-full">
          ...
          <TabsContent value="flashcards">
            {isLoading ? <div className="space-y-4">
              ...
              </div> : flashcards.length > 0 ? <FlashCard question={flashcards[currentIndex].question} answer={flashcards[currentIndex].answer} onNext={handleNext} onPrevious={handlePrevious} onRate={handleRate} hasNext={currentIndex < flashcards.length - 1} hasPrevious={currentIndex > 0} /> : <div className="text-center py-8">
