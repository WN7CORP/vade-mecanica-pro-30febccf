      ...
      <div className="max-w-screen-md mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <button onClick={() => navigate("/")} className="p-2 neomorph-sm">
          ...
          <div className="flex space-x-2">
            {!isSearchPage && <button onClick={() => navigate("/pesquisa")} className="p-2 neomorph-sm" aria-label="Pesquisar">
                <Search size={20} className="text-primary-300" />
              </button>}
            
            {!isAllLawsPage && <button onClick={() => navigate("/leis")} className="p-2 neomorph-sm" aria-label="Ver todas as leis">
